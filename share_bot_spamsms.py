...
bot = telebot.TeleBot("6790339105:AAEKvcd-EmkC3mXI3IDAWVi9uIienb7B-DM")    
#print("\nBot đang hoạt động...\n")
...
list_sdt_admin = ["0764690258"] # list chứa sdt admin
...
def enter_key(message):
    ...
    if enter_key == user_infor[User_id]['key_today']:
        if (enter_key, User_id) in set_key_used:
            ...
            user_infor[User_id]['key_timestamp'] = current_time
            user_infor[User_id]['tong_lan_spam_con_lai_trong_ngay'] = 15
...
def file_random_number(message):
    ...
    file_path_main = f"/sdcard/download/codingpython/{so_luong_so_dien_thoai}_SĐT.txt"
